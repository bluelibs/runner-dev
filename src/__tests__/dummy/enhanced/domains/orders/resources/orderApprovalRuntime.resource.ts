...
export const showcaseDurableResource: typeof memoryDurableResource =
  defineResource({
    id: "durable-runtime",
...
export const showcaseDurableRegistration: ReturnType<
  typeof showcaseDurableResource.with
