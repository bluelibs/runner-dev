...
On development installs, the \`prepare\` script runs \`npm-skills extract --override\` via \`npm run skills:extract\`. When installs omit dev dependencies, npm sets \`npm_config_omit=dev\` and the prepare hook skips extraction cleanly.
