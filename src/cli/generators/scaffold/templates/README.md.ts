...
Generated by \`runner-dev new\` for Runner 6.6.
...
3. Run the smoke checks:
   - npm run qa
4. Check all dependencies (including development tools):
   - npm run audit
...
- audit: Check production and development dependencies with npm audit
