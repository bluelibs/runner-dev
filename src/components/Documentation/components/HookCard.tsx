          ...
          <div>
            ...
            <div style={{ display: 'grid', gap: '15px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '13px', color: '#9c27b0', marginTop: '4px', background: '#f8f9fa', padding: '8px', borderRadius: '4px', fontWeight: '500' }}>
                  {getHookOrderDisplay()}
                  <div style={{ fontSize: '11px', color: '#6c757d', marginTop: '2px', fontWeight: 'normal' }}>
                    {hook.hookOrder === null || hook.hookOrder === undefined 
          ...
          <div>
            ...
            {targetEvent ? (
              <div>
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                    ...
                    <h5 style={{ margin: 0, color: '#4a148c', fontSize: '16px' }}>
                      {targetEvent.meta?.title || formatId(targetEvent.id)}
                    </h5>
                  </div>
                  <div style={{ fontFamily: 'monospace', fontSize: '13px', color: '#6a1b9a', marginBottom: '10px' }}>
                    {targetEvent.id}
                  </div>
                ...
                <div style={{ display: 'grid', gap: '15px' }}>
                  <div style={{
                    ...
                    <div style={{ fontWeight: '600', marginBottom: '8px', color: '#495057' }}>Payload Schema</div>
                    <pre style={{
                      background: '#fff',
                      padding: '12px',
                      borderRadius: '4px',
                  ...
                  <div style={{
                    ...
                    <div style={{ fontWeight: '600', marginBottom: '10px', color: '#495057' }}>Event Statistics</div>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '15px' }}>
                      <div style={{ textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: '12px', color: '#6c757d', fontWeight: '500' }}>Emitters</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#9c27b0' }}>
                          {introspector.getHooksOfEvent(targetEvent.id).length}
                        </div>
                        <div style={{ fontSize: '12px', color: '#6c757d', fontWeight: '500' }}>Hooks</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div style={{ 
                ...
                <h5 style={{ color: '#721c24', margin: '15px 0 10px 0' }}>Event Not Found</h5>
          ...
          <div style={{ marginTop: '30px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '25px' }}>
              {dependencies.tasks.length > 0 && (
                <div>
                  <h5 style={{ margin: '0 0 15px 0', color: '#495057', fontSize: '16px' }}>Task Dependencies</h5>
                  <div style={{ display: 'grid', gap: '10px' }}>
                    {dependencies.tasks.map(dep => (
                      <div key={dep.id} style={{
                        ...
                        <div style={{ fontWeight: '600', color: '#1976d2' }}>{dep.meta?.title || formatId(dep.id)}</div>
              ...
              {emittedEvents.length > 0 && (
                <div>
                  <h5 style={{ margin: '0 0 15px 0', color: '#495057', fontSize: '16px' }}>Emitted Events</h5>
                  <div style={{ display: 'grid', gap: '10px' }}>
                    {emittedEvents.map(event => (
                      <div key={event.id} style={{
                        ...
                        <div style={{ fontWeight: '600', color: '#f57c00' }}>{event.meta?.title || formatId(event.id)}</div>
