        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            <h3 style={{ margin: '0 0 10px 0', fontSize: '24px', fontWeight: '700' }}>
              {getMiddlewareTypeIcon()} {middleware.meta?.title || formatId(middleware.id)}
            </h3>
            ...
            <div style={{ display: 'grid', gap: '15px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: '15px', marginTop: '10px' }}>
                  <div style={{ 
                    ...
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#1976d2' }}>{taskUsages.length}</div>
                    <div style={{ fontSize: '12px', color: '#1976d2', fontWeight: '500' }}>Tasks</div>
                  </div>
                  <div style={{ 
                    background: '#e8f5e8', 
                    padding: '15px', 
                    ...
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#2e7d32' }}>{resourceUsages.length}</div>
                    <div style={{ fontSize: '12px', color: '#2e7d32', fontWeight: '500' }}>Resources</div>
                  </div>
                  <div style={{ 
                    background: '#fff3e0', 
                    padding: '15px', 
                    ...
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#f57c00' }}>{emittedEvents.length}</div>
                    <div style={{ fontSize: '12px', color: '#f57c00', fontWeight: '500' }}>Events</div>
                  </div>
                </div>
              </div>
              ...
              {middleware.global?.enabled && (
                <div style={{ 
                  ...
                  <div style={{ marginTop: '10px', fontSize: '13px', color: '#0c5460' }}>
                    <div style={{ marginBottom: '5px' }}><strong>Tasks:</strong> {middleware.global.tasks ? 'Enabled' : 'Disabled'}</div>
          ...
          <div style={{ marginTop: '30px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '25px' }}>
                    ...
                    {taskUsages.map(usage => (
                      <div key={usage.id} style={{
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '15px' }}>
                          <div style={{ flex: 1 }}>
                            <div style={{ fontWeight: '600', marginBottom: '5px', color: '#2c3e50', fontSize: '16px' }}>
              ...
              {resourceUsages.length > 0 && (
                <div>
                  <h5 style={{ margin: '0 0 15px 0', color: '#495057', fontSize: '16px' }}>Used by Resources</h5>
                  <div style={{ display: 'grid', gap: '10px' }}>
