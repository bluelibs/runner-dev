        ...
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '10px', marginBottom: '15px' }}>
            <div style={{ textAlign: 'center', padding: '10px', background: '#fff', borderRadius: '4px' }}>
              <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#007acc' }}>{introspector.getTasks().length}</div>
              <div style={{ fontSize: '12px', color: '#6c757d' }}>Tasks</div>
            </div>
            <div style={{ textAlign: 'center', padding: '10px', background: '#fff', borderRadius: '4px' }}>
              <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#28a745' }}>{introspector.getResources().length}</div>
              <div style={{ fontSize: '12px', color: '#6c757d' }}>Resources</div>
            </div>
            <div style={{ textAlign: 'center', padding: '10px', background: '#fff', borderRadius: '4px' }}>
              <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#ffc107' }}>{introspector.getEvents().length}</div>
              <div style={{ fontSize: '12px', color: '#6c757d' }}>Events</div>
            </div>
            <div style={{ textAlign: 'center', padding: '10px', background: '#fff', borderRadius: '4px' }}>
              <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#6f42c1' }}>{introspector.getMiddlewares().length}</div>
