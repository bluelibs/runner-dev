...
export type Listener = BaseElement &
  TaskInterface & {
    __typename?: "Listener";
...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> =
  ResolversObject<{
    BaseElement:
      ...
      | (Omit<
          Event,
          "emittedByResolved" | "listenedToByResolved" | "registeredByResolved"
        > & {
          emittedByResolved: Array<_RefType["TaskInterface"]>;
          listenedToByResolved: Array<_RefType["TaskInterface"]>;
      ...
      | (Omit<
        ...
        > & {
          dependsOnResolved: Array<_RefType["BaseElement"]>;
          depenendsOnResolved: Array<_RefType["BaseElement"]>;
          emitsResolved: Array<_RefType["Event"]>;
          middlewareResolved: Array<_RefType["Middleware"]>;
      ...
      | (Omit<
        ...
        > & {
          ...
          usedByTasksResolved: Array<_RefType["TaskInterface"]>;
        })
      | (Omit<
          Resource,
          | "dependsOnResolved"
        ...
        > & {
          ...
          usedBy: Array<_RefType["TaskInterface"]>;
        })
      | (Omit<
          Task,
          | "dependsOnResolved"
...
export type ResolversTypes = ResolversObject<{
  ...
  Event: ResolverTypeWrapper<
    Omit<
      ...
      "emittedByResolved" | "listenedToByResolved" | "registeredByResolved"
    > & {
      emittedByResolved: Array<ResolversTypes["TaskInterface"]>;
      listenedToByResolved: Array<ResolversTypes["TaskInterface"]>;
  ...
  Listener: ResolverTypeWrapper<
    Omit<
      ...
      | "registeredByResolved"
    > & {
      dependsOnResolved: Array<ResolversTypes["BaseElement"]>;
      depenendsOnResolved: Array<ResolversTypes["BaseElement"]>;
      emitsResolved: Array<ResolversTypes["Event"]>;
      middlewareResolved: Array<ResolversTypes["Middleware"]>;
  ...
  Middleware: ResolverTypeWrapper<
    ...
    > & {
      ...
      usedByTasksResolved: Array<ResolversTypes["TaskInterface"]>;
    }
  >;
  ...
  MiddlewareTaskUsage: ResolverTypeWrapper<
    Omit<MiddlewareTaskUsage, "node"> & {
      node: ResolversTypes["TaskInterface"];
    }
  >;
  ...
  Resource: ResolverTypeWrapper<
    ...
    > & {
      ...
      usedBy: Array<ResolversTypes["TaskInterface"]>;
    }
  >;
  RunFilterInput: RunFilterInput;
  RunRecord: ResolverTypeWrapper<
    Omit<RunRecord, "nodeResolved"> & {
      nodeResolved: Maybe<ResolversTypes["TaskInterface"]>;
    }
  >;
  ...
  TaskDependsOn: ResolverTypeWrapper<
    Omit<TaskDependsOn, "emitters" | "listeners" | "resources" | "tasks"> & {
      emitters: Array<ResolversTypes["Event"]>;
      listeners: Array<ResolversTypes["TaskInterface"]>;
      resources: Array<ResolversTypes["Resource"]>;
      tasks: Array<ResolversTypes["TaskInterface"]>;
    }
  >;
  TaskInterface: ResolverTypeWrapper<
    ResolversInterfaceTypes<ResolversTypes>["TaskInterface"]
  >;
  TaskMiddlewareUsage: ResolverTypeWrapper<
    Omit<TaskMiddlewareUsage, "node"> & { node: ResolversTypes["Middleware"] }
  >;
}>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Event: Omit<
    ...
    "emittedByResolved" | "listenedToByResolved" | "registeredByResolved"
  > & {
    emittedByResolved: Array<ResolversParentTypes["TaskInterface"]>;
    listenedToByResolved: Array<ResolversParentTypes["TaskInterface"]>;
  ...
  Listener: Omit<
    ...
    | "registeredByResolved"
  > & {
    dependsOnResolved: Array<ResolversParentTypes["BaseElement"]>;
    depenendsOnResolved: Array<ResolversParentTypes["BaseElement"]>;
    emitsResolved: Array<ResolversParentTypes["Event"]>;
    middlewareResolved: Array<ResolversParentTypes["Middleware"]>;
  ...
  > & {
    ...
    usedByTasksResolved: Array<ResolversParentTypes["TaskInterface"]>;
  };
  ...
  MiddlewareTaskUsage: Omit<MiddlewareTaskUsage, "node"> & {
    node: ResolversParentTypes["TaskInterface"];
  };
  Query: {};
  Resource: Omit<
    Resource,
  ...
  > & {
    ...
    usedBy: Array<ResolversParentTypes["TaskInterface"]>;
  };
  RunFilterInput: RunFilterInput;
  RunRecord: Omit<RunRecord, "nodeResolved"> & {
    nodeResolved: Maybe<ResolversParentTypes["TaskInterface"]>;
  };
  ...
  TaskDependsOn: Omit<
    TaskDependsOn,
    "emitters" | "listeners" | "resources" | "tasks"
  > & {
    emitters: Array<ResolversParentTypes["Event"]>;
    listeners: Array<ResolversParentTypes["TaskInterface"]>;
    resources: Array<ResolversParentTypes["Resource"]>;
    tasks: Array<ResolversParentTypes["TaskInterface"]>;
  };
  ...
  TaskMiddlewareUsage: Omit<TaskMiddlewareUsage, "node"> & {
    node: ResolversParentTypes["Middleware"];
  };
}>;
...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    "All" | "Event" | "Listener" | "Middleware" | "Resource" | "Task",
    ParentType,
    ContextType
  >;
  fileContents: Resolver<
...
> = ResolversObject<{
  ...
  emittedByResolved: Resolver<
    Array<ResolversTypes["TaskInterface"]>,
    ParentType,
    ContextType
  >;
  fileContents: Resolver<
...
export type ListenerResolvers<
  ContextType = CustomGraphQLContext,
  ParentType extends ResolversParentTypes["Listener"] = ResolversParentTypes["Listener"]
> = ResolversObject<{
...
> = ResolversObject<{
  ...
  nodeResolved: Resolver<
    Maybe<ResolversTypes["TaskInterface"]>,
    ParentType,
    ContextType
  >;
...
export type TaskInterfaceResolvers<
  ContextType = CustomGraphQLContext,
  ParentType extends ResolversParentTypes["TaskInterface"] = ResolversParentTypes["TaskInterface"]
> = ResolversObject<{
