...
export const ErrorType = new GraphQLObjectType<ErrorModel, CustomGraphQLContext>(
  {
    name: "Error",
    description: "A defined application error that can be thrown by tasks or resources",
