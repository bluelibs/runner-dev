export const SYSTEM_PROMPT = [
  ...
  "",
  "Do NOT treat @docs.runner, @docs.runnerDev, @docs.schema, or @docs.projectOverview as element ids.",
  ...
  "Use these blocks for reasoning and do not attempt to fetch them via tools.",
  ...
  "Do not claim you cannot read the project overview/schema/docs if such blocks are present in the conversation history.",
  "",
  "EXAMPLE:",
