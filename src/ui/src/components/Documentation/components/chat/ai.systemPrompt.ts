export const SYSTEM_PROMPT = [
  ...
  "- When a chart, illustration, or drawing would clarify the answer, use Mermaid fenced blocks in the form ```mermaid ... ```, not ASCII diagrams.",
  "- Keep Mermaid syntax simple and broadly compatible. For flowcharts, prefer `flowchart TD`.",
  "- Always quote Mermaid node labels, for example `A[\"run(app)\"]` and `B[\"emit events.ready\"]`.",
