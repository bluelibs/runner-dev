        ...
        <div style={{ marginTop: '30px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '15px', marginBottom: '25px' }}>
            <div style={{ 
              ...
              borderRadius: '8px',
              textAlign: 'center',
              border: `2px solid ${emitters.length > 0 ? '#c3e6cb' : '#f5c6cb'}`
            }}>
              <div style={{ fontSize: '24px', fontWeight: 'bold', color: emitters.length > 0 ? '#155724' : '#721c24' }}>
                {emitters.length}
              </div>
              <div style={{ fontSize: '14px', fontWeight: '500', color: emitters.length > 0 ? '#155724' : '#721c24' }}>
                Emitters
              </div>
            </div>
            <div style={{ 
              ...
              <div style={{ fontSize: '24px', fontWeight: 'bold', color: hooks.length > 0 ? '#155724' : '#856404' }}>
                {hooks.length}
              </div>
              <div style={{ fontSize: '14px', fontWeight: '500', color: hooks.length > 0 ? '#155724' : '#856404' }}>
                Listeners
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '25px' }}>
            {emitters.length > 0 && (
              <div>
                <h5 style={{ margin: '0 0 15px 0', color: '#495057', fontSize: '16px' }}>Event Emitters</h5>
                    ...
                    return (
                      <div key={emitter.id} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <span>{icon}</span>
                          <div>
                            <div style={{ fontWeight: '600', color: borderColor === '#2196f3' ? '#1976d2' : borderColor === '#9c27b0' ? '#7b1fa2' : '#2e7d32' }}>
            ...
            {hooks.length > 0 && (
              <div>
                <h5 style={{ margin: '0 0 15px 0', color: '#495057', fontSize: '16px' }}>Event Listeners</h5>
                <div style={{ display: 'grid', gap: '10px' }}>
                  {hooks.map(hook => (
